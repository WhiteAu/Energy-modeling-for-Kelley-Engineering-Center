# Django settings for KEC_Energy project.
...
DATABASE_NAME = 'KEC_DB'             # Or path to database file if using sqlite3.
...
SECRET_KEY = 'i%q&m^anjaud(t+-+x5vlbpsb13%g+(497$i@m2^5480+#^gdy'
